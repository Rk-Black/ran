...
{B} [{R}✔{B}] {Y}TOOL OWNER  :{G} MD Riyadul Momin

{B} [{R}✔{B}] {B}FACEBOOK   :{G} facebook.com/Itz.riad.khule.khele.dibo

{B} [{R}✔{B}] {nb}WHATSAPP   :{G} +17867244875

{B} [{R}✔{B}] {Y}GITHUB  :{G} github.com/Rk-Black/
...
def fb():
    ...
    s("xdg-open https://www.facebook.com/Itz.riad.khule.khele.dibo")

def git():

    s(" os.system('xdg-open https://github.com/Rk-Black)")

def git():

    s("xdg-open https://github.com/Rk-Black")
...
def o():
    ...
    if opt == '1':
        ...
        s("xdg-open https://www.facebook.com/profile.php?id=100021994530776")
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/Rk.Black.Hacker.Zone', {
...
def i():
    ...
    s("xdg-open https://youtube.com/@rktrickspoint8161")
